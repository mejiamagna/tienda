...
a persistence unit "tiendaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "tienda/pom.xml":
...
artifact ("tienda.war") is already built. You can build
